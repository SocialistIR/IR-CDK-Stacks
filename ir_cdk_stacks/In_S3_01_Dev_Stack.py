...
class InS301DevStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        custom_allow_policy = iam.ManagedPolicy(self,
                                         ...
                                         statements=[
                                             iam.PolicyStatement(
                                                 ...
                                                 resources=["arn:aws:s3:::socialistir-dev",
                                                            "arn:aws:s3:::socialistir-dev/*"]
                                             )
                                         ])
        ...
        ############ This section should be executed only once in lifetime as     ############################################
        ############ AWS CDK does not support destion of S3 buckects yet and will ############################################
        ############ throw errors on subsequent deploy or destruct or rollback    ############################################
        ############          S3 bucts are global across all AWS accounts         ############################################
        # 
        # bucket = s3.Bucket(self,
        #     id = 'socialistir-dev', 
        #     bucket_name='socialistir-dev', 
        #     versioned=True, 
        ...
        # 
        # trail.add_s3_event_selector(["arn:aws:s3:::socialistir-dev/"],
        ...
        lambda_dir_path =  os.path.join(os.getcwd(), "ir_cdk_stacks", "in_s3_01")
